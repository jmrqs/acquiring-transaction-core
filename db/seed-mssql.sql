IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'acquiringtransactioncoreaccount')
BEGIN
    CREATE DATABASE acquiringtransactioncoreaccount;
END
GO

USE acquiringtransactioncoreaccount;
GO
